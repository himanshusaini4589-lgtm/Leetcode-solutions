<h2><a href="https://leetcode.com/problems/transform-binary-string-using-subsequence-sort/">3998. Transform Binary String Using Subsequence Sort</a></h2><h3>Medium</h3><hr><p>You are given a <span data-keyword="binary-string">binary string</span> <code>s</code>.</p>
